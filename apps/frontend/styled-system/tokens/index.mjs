const tokens = {
  ...
  "colors.shark": {
    "value": "#1C1C1E",
    "variable": "var(--colors-shark)"
  },
  "colors.athensGrey": {
    "value": "#F8F9FA",
    "variable": "var(--colors-athens-grey)"
  },
  "colors.green": {
    "value": "#2CB34A",
  ...
  "colors.rollingStone": {
    "value": "#7D7F81",
    "variable": "var(--colors-rolling-stone)"
  },
  "colors.white": {
    "value": "#FFFFFF",
  ...
  "colors.woosmoke": {
    "value": "#0D0D0E",
    "variable": "var(--colors-woosmoke)"
  },
  "colors.toscanny": {
    "value": "#BE472B",
    "variable": "var(--colors-toscanny)"
  },
  "colors.sunglo": {
    "value": "#E36969",
    "variable": "var(--colors-sunglo)"
  },
  "colors.whiteWithOpacity75": {
    "value": "rgba(255, 255, 255, 0.75)",
    "variable": "var(--colors-white-with-opacity75)"
  },
  "colors.blackWithOpacity25": {
    "value": "rgba(0, 0, 0, 0.25)",
    "variable": "var(--colors-black-with-opacity25)"
  },
  "colors.transparent": {
    "value": "transparent",
    "variable": "var(--colors-transparent)"
  },
  "colors.brand.brightBlue": {
    "value": "#276CB1",
    "variable": "var(--colors-brand-bright-blue)"
  },
  "colors.brand.flesh": {
    "value": "#2fde",
    "variable": "var(--colors-brand-flesh)"
  },
  "colors.brand.goldenYellow": {
    "value": "#FFED00",
    "variable": "var(--colors-brand-golden-yellow)"
  },
  "colors.brand.icedAqua": {
    "value": "#BCDCE2",
    "variable": "var(--colors-brand-iced-aqua)"
  },
  "colors.brand.lightSalmon": {
    "value": "#F4B39E",
    "variable": "var(--colors-brand-light-salmon)"
  },
  "colors.brand.lightSalmonWithOpacity25": {
    "value": "rgba(244, 179, 158, 0.25)",
    "variable": "var(--colors-brand-light-salmon-with-opacity25)"
  },
  "colors.brand.red": {
    "value": "#FF5E30",
    "variable": "var(--colors-brand-red)"
  },
  "colors.brand.redWithOpacity25": {
    "value": "rgba(255, 94, 48, 0.25)",
    "variable": "var(--colors-brand-red-with-opacity25)"
  },
  "colors.brand.seaBlue": {
    "value": "#8CCBD4",
    "variable": "var(--colors-brand-sea-blue)"
  },
  "colors.brand.silver": {
    "value": "#B8C9C4",
    "variable": "var(--colors-brand-silver)"
  },
  "colors.brand.silverWithOpacity25": {
    "value": "rgba(184, 201, 196, 0.25)",
    "variable": "var(--colors-brand-silver-with-opacity25)"
  },
  "colors.brand.black": {
    "value": "#050101",
    "variable": "var(--colors-brand-black)"
  },
  "colors.brand.orange": {
    "value": "#FF5E30",
    "variable": "var(--colors-brand-orange)"
  },
  "colors.brand.orangeWithOpacity25": {
    "value": "rgba(255, 94, 48, 0.25)",
    "variable": "var(--colors-brand-orange-with-opacity25)"
  },
  "colors.springWood": {
    "value": "grey",
    "variable": "var(--colors-spring-wood)"
  },
  "breakpoints.sm": {
    "value": "640px",
  ...
  "colors.colorPalette.brightBlue": {
    "value": "var(--colors-color-palette-bright-blue)",
    "variable": "var(--colors-color-palette-bright-blue)"
  },
  "colors.colorPalette.flesh": {
    "value": "var(--colors-color-palette-flesh)",
    "variable": "var(--colors-color-palette-flesh)"
  },
  "colors.colorPalette.goldenYellow": {
    "value": "var(--colors-color-palette-golden-yellow)",
    "variable": "var(--colors-color-palette-golden-yellow)"
  },
  "colors.colorPalette.icedAqua": {
    "value": "var(--colors-color-palette-iced-aqua)",
    "variable": "var(--colors-color-palette-iced-aqua)"
  },
  "colors.colorPalette.lightSalmon": {
    "value": "var(--colors-color-palette-light-salmon)",
    "variable": "var(--colors-color-palette-light-salmon)"
  },
  "colors.colorPalette.lightSalmonWithOpacity25": {
    "value": "var(--colors-color-palette-light-salmon-with-opacity25)",
    "variable": "var(--colors-color-palette-light-salmon-with-opacity25)"
  },
  "colors.colorPalette.red": {
    "value": "var(--colors-color-palette-red)",
    "variable": "var(--colors-color-palette-red)"
  },
  "colors.colorPalette.redWithOpacity25": {
    "value": "var(--colors-color-palette-red-with-opacity25)",
    "variable": "var(--colors-color-palette-red-with-opacity25)"
  },
  "colors.colorPalette.seaBlue": {
    "value": "var(--colors-color-palette-sea-blue)",
    "variable": "var(--colors-color-palette-sea-blue)"
  },
  "colors.colorPalette.silver": {
    "value": "var(--colors-color-palette-silver)",
    "variable": "var(--colors-color-palette-silver)"
  },
  "colors.colorPalette.silverWithOpacity25": {
    "value": "var(--colors-color-palette-silver-with-opacity25)",
    "variable": "var(--colors-color-palette-silver-with-opacity25)"
  },
  ...
  "colors.colorPalette.orangeWithOpacity25": {
    "value": "var(--colors-color-palette-orange-with-opacity25)",
    "variable": "var(--colors-color-palette-orange-with-opacity25)"
  }
}
